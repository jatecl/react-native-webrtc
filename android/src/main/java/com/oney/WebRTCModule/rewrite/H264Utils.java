...
class H264Utils {
  ...
  public static boolean isSameH264Profile(Map<String, String> params1, Map<String, String> params2) {
    try {
      Class clazz = Class.forName("org.webrtc.H264Utils");
      Method method = clazz.getDeclaredMethod("isSameH264Profile", Map.class, Map.class);
      Object obj = method.invoke(null, params1, params2);
      return (boolean)obj;
